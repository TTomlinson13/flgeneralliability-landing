  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl mx-4 rounded-2xl overflow-hidden shadow-2xl" style={{ maxHeight: '90vh' }}>
        ...
        >×</button>
        <iframe
          src={`https://form.jotform.com/261320420063137`}
      ...
      <section className="relative bg-green-900 py-16 md:py-24 px-4 text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3">
            ...
            <button onClick={() => setShowJotform(true)} className="bg-white hover:bg-green-50 text-green-800 px-7 py-4 rounded-xl font-bold text-base transition shadow-lg text-center">
              <span className="block text-xl mb-0.5">📝</span>
              Full Quote Form
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-green-600 to-green-700">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={() => setShowJotform(true)} className="bg-white text-green-700 font-bold text-xl py-4 px-8 rounded-lg shadow-lg hover:bg-slate-100 transition">
              Get GL Quote →
            </button>
